...
export const EXTERNAL_ACTION_REGISTRATIONS: readonly ExternalActionRegistration[] = [
  ...
  canonicalRead('money.read', 'money.read', 'kwilt_money_read', 'Read Private Money Summary', ['money.read'], 'money_summary'),
  canonicalWrite('money.review_transaction', 'money.review_transaction', 'kwilt_money_review_transaction', 'Open Transaction Review', ['money.read', 'money.write'], 'consequential', 'native'),
  canonicalWrite('money.category.create', 'money.category.create', 'kwilt_money_category_create', 'Create Money Category', ['money.read', 'money.write'], 'consequential', 'explicit'),
  canonicalWrite('money.category.rename', 'money.category.rename', 'kwilt_money_category_rename', 'Rename Money Category', ['money.read', 'money.write'], 'low', 'explicit'),
  canonicalWrite('money.app_control.review', 'money.app_control.review', 'kwilt_money_app_control_review', 'Review Money App Control', ['money.read', 'money.write'], 'consequential', 'native'),
  canonicalWrite('money.category.update', 'money.category.update', 'kwilt_money_category_update', 'Open Money Category Review', ['money.read', 'money.write'], 'consequential', 'native'),
  canonicalWrite('money.privacy.configure', 'money.privacy.configure', 'kwilt_money_privacy_configure', 'Open Money Privacy', ['money.read', 'money.write'], 'consequential', 'native'),
  canonicalWrite('money.connection.connect', 'money.connection.connect', 'kwilt_money_connection_connect', 'Connect Money Account', ['money.read', 'money.write'], 'consequential', 'native'),
  canonicalWrite('money.connection.sync', 'money.connection.sync', 'kwilt_money_connection_sync', 'Open Money Sync', ['money.read', 'money.write'], 'low', 'native'),
  ...
  canonicalWrite('navigation.open_capability', 'navigation.open_capability', 'kwilt_navigation_open_capability', 'Open Kwilt Capability', ['life.read', 'life.write'], 'low', 'native'),
  canonicalRead('settings.haptics.read', 'settings.haptics.read', 'kwilt_settings_haptics_read', 'Read Device Haptics', ['life.read'], 'bounded_summary'),
  canonicalWrite('settings.haptics.update', 'settings.haptics.update', 'kwilt_settings_haptics_update', 'Update Device Haptics', ['life.read', 'life.write'], 'low', 'explicit'),
  canonicalRead('settings.widgets.read', 'settings.widgets.read', 'kwilt_settings_widgets_read', 'Read Device Widget Status', ['life.read'], 'bounded_summary'),
  canonicalWrite('settings.widgets.configure', 'settings.widgets.configure', 'kwilt_settings_widgets_configure', 'Open Widget Setup', ['life.read', 'life.write'], 'low', 'native'),
  canonicalRead('settings.appearance.read', 'settings.appearance.read', 'kwilt_settings_appearance_read', 'Read Device Appearance', ['life.read'], 'bounded_summary'),
  canonicalWrite('settings.appearance.update', 'settings.appearance.update', 'kwilt_settings_appearance_update', 'Update Device Appearance', ['life.read', 'life.write'], 'low', 'explicit'),
  canonicalRead('settings.connected_tools.list', 'settings.connected_tools.list', 'kwilt_settings_connected_tools_list', 'List Apps and Connections', ['life.read'], 'bounded_summary'),
  canonicalRead('settings.connected_tools.get', 'settings.connected_tools.get', 'kwilt_settings_connected_tools_get', 'Get App Connection', ['life.read'], 'bounded_summary'),
  canonicalWrite('settings.connected_tools.connect.open', 'settings.connected_tools.connect.open', 'kwilt_settings_connected_tools_connect_open', 'Connect App', ['life.read', 'life.write'], 'consequential', 'native'),
  canonicalWrite('settings.connected_tools.revoke', 'settings.connected_tools.revoke', 'kwilt_settings_connected_tools_revoke', 'Disconnect App', ['life.read', 'life.write'], 'consequential', 'explicit'),
  canonicalRead('settings.phone_agent.read', 'settings.phone_agent.read', 'kwilt_settings_phone_agent_read', 'Read Phone Agent Settings', ['life.read'], 'bounded_summary'),
  canonicalWrite('settings.phone_agent.update', 'settings.phone_agent.update', 'kwilt_settings_phone_agent_update', 'Update Phone Agent Settings', ['life.read', 'life.write'], 'consequential', 'explicit'),
  canonicalRead('settings.ai_model.read', 'settings.ai_model.read', 'kwilt_settings_ai_model_read', 'Read AI Model', ['life.read'], 'bounded_summary'),
  canonicalWrite('settings.ai_model.update', 'settings.ai_model.update', 'kwilt_settings_ai_model_update', 'Update AI Model', ['life.read', 'life.write'], 'consequential', 'explicit'),
  canonicalRead('settings.sharing.list', 'settings.sharing.list', 'kwilt_settings_sharing_list', 'List Sharing Connections', ['life.read'], 'bounded_summary'),
  canonicalWrite('settings.sharing.invitation.prepare', 'settings.sharing.invitation.prepare', 'kwilt_settings_sharing_invitation_prepare', 'Invite a Friend', ['life.read', 'life.write'], 'consequential', 'native'),
  canonicalWrite('settings.sharing.connection.revoke', 'settings.sharing.connection.revoke', 'kwilt_settings_sharing_connection_revoke', 'Revoke Sharing Connection', ['life.read', 'life.write'], 'consequential', 'explicit'),
  canonicalRead('settings.execution_targets.list', 'settings.execution_targets.list', 'kwilt_settings_execution_targets_list', 'List Execution Targets', ['life.read'], 'bounded_summary'),
  canonicalRead('settings.execution_targets.get', 'settings.execution_targets.get', 'kwilt_settings_execution_targets_get', 'Get Execution Target', ['life.read'], 'bounded_summary'),
  canonicalWrite('settings.execution_targets.create', 'settings.execution_targets.create', 'kwilt_settings_execution_targets_create', 'Install Execution Target', ['life.read', 'life.write'], 'consequential', 'explicit'),
  canonicalWrite('settings.execution_targets.update', 'settings.execution_targets.update', 'kwilt_settings_execution_targets_update', 'Update Execution Target', ['life.read', 'life.write'], 'consequential', 'explicit'),
  canonicalWrite('settings.execution_targets.delete', 'settings.execution_targets.delete', 'kwilt_settings_execution_targets_delete', 'Delete Execution Target', ['life.read', 'life.write'], 'consequential', 'explicit'),
  canonicalRead('settings.destinations.list', 'settings.destinations.list', 'kwilt_settings_destinations_list', 'List Send To Destinations', ['life.read'], 'bounded_summary'),
  canonicalRead('settings.destinations.get', 'settings.destinations.get', 'kwilt_settings_destinations_get', 'Get Send To Destination', ['life.read'], 'bounded_summary'),
  canonicalWrite('settings.destinations.create', 'settings.destinations.create', 'kwilt_settings_destinations_create', 'Install Send To Destination', ['life.read', 'life.write'], 'low', 'explicit'),
  canonicalWrite('settings.destinations.delete', 'settings.destinations.delete', 'kwilt_settings_destinations_delete', 'Uninstall Send To Destination', ['life.read', 'life.write'], 'low', 'explicit'),
  canonicalRead('settings.activity_areas.list', 'settings.activity_areas.list', 'kwilt_settings_activity_areas_list', 'List Activity Areas', ['life.read'], 'bounded_summary'),
  canonicalRead('settings.activity_areas.get', 'settings.activity_areas.get', 'kwilt_settings_activity_areas_get', 'Get Activity Area', ['life.read'], 'bounded_summary'),
  canonicalWrite('settings.activity_areas.create', 'settings.activity_areas.create', 'kwilt_settings_activity_areas_create', 'Create Activity Area', ['life.read', 'life.write'], 'low', 'explicit'),
  canonicalWrite('settings.activity_areas.update', 'settings.activity_areas.update', 'kwilt_settings_activity_areas_update', 'Rename Activity Area', ['life.read', 'life.write'], 'low', 'explicit'),
  canonicalWrite('settings.activity_areas.delete', 'settings.activity_areas.delete', 'kwilt_settings_activity_areas_delete', 'Archive Activity Area', ['life.read', 'life.write'], 'consequential', 'explicit'),
  canonicalWrite('channel.phone.continue_run', 'channel.phone.continue_run', 'kwilt_phone_continue_conversation', 'Continue Conversation on Phone Agent', ['life.read', 'life.write'], 'low', 'none'),
