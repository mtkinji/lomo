...
> = Object.freeze({
  ...
  conversation_summary: contract({ id: 'conversation_summary', owner: 'chat', privacyClass: 'private_text', cloudFallbackPolicy: 'allowed', cloudTier: 'economy', cloudModel: 'gpt-4o-mini', local: local('challenger', 8_000, 256) }),
  ...
  chat_rewrite: contract({ id: 'chat_rewrite', owner: 'chat', privacyClass: 'private_text', cloudFallbackPolicy: 'allowed', cloudTier: 'economy', cloudModel: 'gpt-4o-mini', local: local('default', 3_000, 96) }),
  chat_proofread: contract({ id: 'chat_proofread', owner: 'chat', privacyClass: 'private_text', cloudFallbackPolicy: 'allowed', cloudTier: 'economy', cloudModel: 'gpt-4o-mini', local: local('default', 3_000, 96) }),
  chat_shorten: contract({ id: 'chat_shorten', owner: 'chat', privacyClass: 'private_text', cloudFallbackPolicy: 'allowed', cloudTier: 'economy', cloudModel: 'gpt-4o-mini', local: local('default', 3_000, 96) }),
  chat_summarize: contract({ id: 'chat_summarize', owner: 'chat', privacyClass: 'private_text', cloudFallbackPolicy: 'allowed', cloudTier: 'economy', cloudModel: 'gpt-4o-mini', local: local('default', 3_000, 128) }),
  chat_brainstorm: contract({ id: 'chat_brainstorm', owner: 'chat', privacyClass: 'ordinary_text', cloudFallbackPolicy: 'allowed', cloudTier: 'economy', cloudModel: 'gpt-4o-mini', local: local('default', 1_200, 128) }),
  thread_title: contract({ id: 'thread_title', owner: 'chat', privacyClass: 'private_text', cloudFallbackPolicy: 'allowed', cloudTier: 'economy', cloudModel: 'gpt-4o-mini', local: local('default', 2_400, 32) }),
});
