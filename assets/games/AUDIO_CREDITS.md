...
- Source: https://freesound.org/people/1888software/sounds/575525/
- License: Creative Commons CC0 1.0 Universal
- License text: https://creativecommons.org/publicdomain/zero/1.0/
- Changes: Freesound's high-quality MP3 preview is used for brief in-game playback.
...
`doubles-celebration.wav` is adapted from “Success Sound effect” by Freesound user Nomagician.

- Source: https://freesound.org/people/Nomagician/sounds/833630/
- License: Creative Commons CC0 1.0 Universal
- Changes: converted to 48 kHz stereo PCM, trimmed, and faded for in-game playback.

## Success sparkle

`success-sparkle.wav` is adapted from “Bell Tree (bell_tree_scrape3.wav)” by Freesound user sgossner, recorded for the VSCO 2 Community Edition sampling project.

- Source: https://freesound.org/people/sgossner/sounds/375598/
- License: Creative Commons CC0 1.0 Universal
- Changes: converted to 48 kHz stereo PCM, trimmed, and faded for rapid pattern playback.

## Success fanfare

`success-fanfare.wav` is adapted from “Clean Trumpet Fanfare” by Freesound user joepayne.
...
`bank-bust.wav` is adapted from “wah wah sad trombone.wav” by Freesound user kirbydx.

- Source: https://freesound.org/people/kirbydx/sounds/175409/
- License: Creative Commons CC0 1.0 Universal
- Changes: converted to 48 kHz stereo PCM, trimmed, and faded for in-game playback.

## Failure bonk

`failure-bonk.wav` is adapted from “Bonk Sound effect” by Freesound user thecoolcookie17.
...
`failure-wobble.wav` is adapted from “Cartoon Wobble” by Freesound user Breviceps.

- Source: https://freesound.org/people/Breviceps/sounds/542195/
- License: Creative Commons CC0 1.0 Universal
- Changes: converted to 48 kHz stereo PCM, trimmed, and faded for in-game playback.
