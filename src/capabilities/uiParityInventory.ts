...
export const UI_PARITY_SURFACES = [
  ...
  included('account-settings', 'Account and general settings', [
    ...
    intent('settings.destinations.manage', 'List, inspect, install, or uninstall curated Send to destinations',
  ...
  included('money', 'Money', [
    ...
    'MoneyCategoryCreate', 'MoneyAccounts', 'SettingsMoneyPrivacy', 'SettingsBudget',
  ], [
  ...
  included('chores', 'Chores', ['Chores'], [
    ...
    intent('chores.occurrence.complete', 'Complete a chore and attach required evidence',
      ...
      'chores.occurrence.reopen', 'chores.occurrence.report_earlier', 'chores.evidence.add'),
