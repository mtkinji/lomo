...
const acceptedGameCatalog: GameDefinition[] = [
  ...
  { id: 'same-page', title: 'Show of Hands', promise: 'Pick in secret. Reveal together. Rally the room.', minPlayers: 2, maxPlayers: 8, accent: '#FF8F78', mark: 'Ⅲ', route: { kind: 'connection', gameId: 'same-page' }, remotePath: 'A shared problem on one screen with simultaneous finger-vote reveals.', durationMinutes: [5, 10], energy: 'lively', releaseStatus: 'ready' },
  ...
  { id: 'story-relay', title: 'Story Relay', promise: 'Pass one wild story around the family.', minPlayers: 2, maxPlayers: 6, accent: '#F0A75E', mark: '✦', route: { kind: 'connection', gameId: 'story-relay' }, remotePath: 'Ordered private turns on a synchronized ephemeral story.', durationMinutes: [10, 20], energy: 'creative', releaseStatus: 'ready' },
