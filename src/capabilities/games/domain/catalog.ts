...
const acceptedGameCatalog: GameDefinition[] = [
  ...
  { id: 'same-page', title: 'Oddball', promise: 'Match the biggest group. Don’t stand alone.', minPlayers: 3, maxPlayers: 8, accent: '#FF8F78', mark: '●', route: { kind: 'connection', gameId: 'same-page' }, remotePath: 'Shared/cast board with host-scored reveals; synchronized private voting is deferred.', durationMinutes: [10, 15], energy: 'lively', releaseStatus: 'ready' },
