...
const styles = StyleSheet.create({
  ...
  soundChoices: { flexDirection: 'row', gap: 7 },
  soundChoice: { flex: 1, minHeight: 40, borderRadius: gamesTheme.radius.pill, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: 'rgba(32,29,24,0.18)', backgroundColor: gamesTheme.colors.white },
