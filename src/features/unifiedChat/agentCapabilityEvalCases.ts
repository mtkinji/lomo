...
export const OPERATION_LANGUAGE_CASES: readonly OperationLanguageCase[] = [
  ...
  languageCase('household.read', 'Who is in my Household, and what can each caregiver manage?'),
  languageCase('household.member.add_dependent', 'Add Charlie as a dependent child in my Household.'),
  languageCase('household.invitation.create', 'Invite alex@example.com to my Household as a caregiver.'),
  languageCase('household.invitation.preview', 'Show me who sent Household invitation ABC123 before I join.'),
  languageCase('household.invitation.accept', 'Accept the Household invitation ABC123 for me.'),
  languageCase('household.child_capability.update', 'Enable Screen Time for Charlie in my Household.'),
  languageCase('household.caregiver_grant.update', "Let Alex manage Charlie's Screen Time."),
