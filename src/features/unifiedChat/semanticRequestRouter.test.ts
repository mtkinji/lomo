...
describe('semanticRequestRouter', () => {
  ...
  it.each([
    ['unknown capability', { requestClass: 'capability_question', participatingCapabilities: ['future_capability'], usePrivateContext: true, informationNeed: 'stable', confidence: 0.9, reason: 'Unknown.' }],
