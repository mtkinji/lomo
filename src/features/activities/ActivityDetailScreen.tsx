...
import { Alert, InteractionManager, LayoutAnimation, View, TextInput, Platform, Keyboard, Share, Linking, useWindowDimensions, findNodeHandle, UIManager } from 'react-native';
