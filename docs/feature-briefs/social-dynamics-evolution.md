## feature brief — Social Dynamics Evolution (Beyond Shared Goals v1)
...
This feature brief is the **canonical roadmap** for social feature evolution post-v1. It builds on existing primitives and respects Kwilt's privacy-first, signals-only philosophy.

### References

- Shared goals v1 feature brief: `docs/feature-briefs/social-goals-auth.md`
...
Per `docs/feature-briefs/social-goals-auth.md`:
