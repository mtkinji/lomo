## feature brief — Shared Goals + Auth (Apple + Google) + Signals-Only Social Mechanics
...
This feature brief is the **canonical source of truth** for:
...
- Growth context: `docs/feature-briefs/growth-evangelism-shared-goals.md`
- UX constraints: preserve **app shell + canvas** (`docs/ux-flow.md`, `docs/ui-architecture.md`)
- Notifications posture (deep links + caps): `docs/notifications-paradigm-prd.md`, `docs/feature-briefs/notifications-v1-5.md`
...
The repo includes a Phase 0 “share message without accounts” concept (`docs/feature-briefs/growth-evangelism-shared-goals.md`, `docs/onboarding-cycle-plan.md`).
...
- 🟡 **Analytics instrumentation**: implemented for share/join flows, but event names differ from feature brief’s suggested canonical names (`src/services/analytics/events.ts`)
