...
The 2026-08-27 parity census supersedes the stale 60-operation count in the earlier checkpoint: the canonical manifest now contains 233 operations, all mapped exactly once across 23 audited native surfaces and 122 user-intent groups. The original 83-operation expansion became 88 when the production Chores audit split take, return, reopen, earlier-completion correction, and leave-missed into their own contracts. The 33 previously prioritized gaps now have canonical contracts; this does not promote their pending providers to working behavior. Current channel counts and drift rules live in [`2026-08-27-ui-parity-inventory.md`](../delivery-evidence/unified-chat/2026-08-27-ui-parity-inventory.md).
