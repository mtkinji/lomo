## feature brief — Auto‑Schedule (calendar connections + scheduling guidance + auto placement)
...
- Calendar model + ICS export foundation: `docs/feature-briefs/calendar-export-ics.md`
...
This feature brief defines both, with **V1 targeting Version A** and laying a clean path to Version B.
...
- `.ics` export via share sheet (`docs/feature-briefs/calendar-export-ics.md`)
