...
| `money.read` | `money.read` | yes | yes | yes | none | device_handoff_or_answer |
| `money.review_transaction` | `money.review_transaction` | yes | yes | yes | native | native_handoff |
| `money.category.create` | `money.category.create` | yes | yes | yes | explicit | proposal_or_device_handoff |
| `money.category.rename` | `money.category.rename` | yes | yes | yes | explicit | proposal_or_device_handoff |
| `money.app_control.review` | `money.app_control.review` | yes | yes | yes | native | native_handoff |
| `money.category.update` | `money.category.update` | yes | yes | yes | native | native_handoff |
| `money.privacy.configure` | `money.privacy.configure` | yes | yes | yes | native | native_handoff |
| `money.connection.connect` | `money.connection.connect` | yes | yes | yes | native | native_handoff |
| `money.connection.sync` | `money.connection.sync` | yes | yes | yes | native | native_handoff |
...
| `channel.phone.continue_run` | `channel.phone.continue_run` | yes | yes | yes | none | complete |
