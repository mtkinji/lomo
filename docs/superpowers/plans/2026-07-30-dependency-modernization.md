...
- Remaining Step 4 gate: a newly built signed-device binary, notification/background/location/audio/HealthKit/Plaid/RevenueCat/Screen Time/widget proof, TestFlight, and at least 48 hours of normal dogfood use remain open. The paired iPhone 16 remained unavailable to CoreDevice and absent from the Mac USB inventory during this checkpoint. Android generation is inspected, but this Mac has no configured Android emulator/ADB runtime. Do not tag or advance to SDK 56 until these gates pass.
