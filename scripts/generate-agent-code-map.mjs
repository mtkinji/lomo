...
lines.push('');
for (const script of ['verify:changed', 'lint', 'lint:tests', 'test', 'test:ci', 'lint:supabase-functions', 'product:lint', 'architecture:lint', 'mcp:smoke', 'mcp:e2e']) {
...
lines.push('- CI enforces the stable repo-wide gates: app typecheck, test typecheck, product lint, architecture lint, and coverage Jest.');
lines.push('');
