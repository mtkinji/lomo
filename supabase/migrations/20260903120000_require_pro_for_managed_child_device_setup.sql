-- Named-child device enrollment creates Kwilt-managed Household topology.
-- Keep local in-person Apple authorization available without a subscription,
-- but require Pro before a caregiver can issue this remote pairing credential.
