-- Kwilt: Add credit velocity metrics to admin use summary RPC.
-- Extends kwilt_admin_use_summary with credits per day, monthly totals, and time-to-engagement metrics.
